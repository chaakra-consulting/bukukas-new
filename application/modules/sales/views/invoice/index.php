...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoices-table").appTable({
            ...
            // invoices: [[1, "asc"]],
            columns: [
                { title: "No. SPK", "class": "text-center" , width: "5%"},
                { title: "Project", "class": "text-center" , width: "20%"},
                ...
                // { title: "Total Terbayar", "class": "text-center" },
                { title: "Status Pembayaran", "class": "text-center" },
                { title: "Jenis", "class": "text-center" },
                { title: "Nama Instansi", "class": "text-center" },
