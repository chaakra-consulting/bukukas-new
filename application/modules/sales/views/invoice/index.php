                   ...
                   <tr>
                       ...
                       <td><input type="text" class="form-control" name="end" id="end" value="<?php echo $end_date ?>" autocomplete="off"></td>
                        <td>
                           ...
                           <a href="#" name="print"  class="btn btn-default" onclick="tableToExcel('invoices-table', 'Lap_Pembelian')"><i class=" fa fa-file-excel-o"></i> Excel</a>
